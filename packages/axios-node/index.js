    ...
    return wrapAsync(async function dispatchHttpRequest(resolve, reject, onDone) {
      ...
      if (data && (onUploadProgress || maxUploadRate)) {
        ...
        onUploadProgress
          && data.on(
            'progress',
            flushOnFinish(data, progressEventDecorator(contentLength, progressEventReducer(asyncDecorator(onUploadProgress), false, 3))),
          );
      }
        ...
        if (onDownloadProgress || maxDownloadRate) {
          ...
          onDownloadProgress
            && transformStream.on(
              ...
              flushOnFinish(
                transformStream,
                progressEventDecorator(responseLength, progressEventReducer(asyncDecorator(onDownloadProgress), true, 3)),
              ),
            );
