...
const slashEnd = baseUtils.slash.end;
const cachedResult = {};
...
exports.getMonoDevData = function (/** @type DevInfo */ devInfo, inputAppSrc, options = {}) {
  ...
  helMonoLog('appData.appPublicUrl ', appData.appPublicUrl);
  helMonoLog('appInfo.getPublicPathOrUrl(devPublicUrl)l ', appInfo.getPublicPathOrUrl(devPublicUrl));

  let appPublicUrl = slashEnd(devPublicUrl);
  if (isHelModeVar) {
    appPublicUrl = isHelStart() ? slashEnd(devPublicUrl) : appInfo.getPublicPathOrUrl(devPublicUrl);
